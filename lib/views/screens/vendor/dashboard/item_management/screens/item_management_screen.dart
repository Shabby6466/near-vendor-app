            ...
            children: [
              Column(
                children: [
                  ...
                  Expanded(
                    child: BlocBuilder<ItemManagementCubit, ItemManagementState>(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  onPressed: () => _showItemForm(context),
                  icon: Icon(Icons.add_box_rounded, color: theme.primaryColor, size: 24),
                ),
              ),
            ],
          ),
        ...
        PopupMenuItem(
          ...
          child: Row(
            children: [
              ...
              Text('Edit Item', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, color: theme.textTheme.bodyMedium?.color)),
            ],
          ),
        ),
        PopupMenuItem(
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Delete Item?', style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.w700, color: theme.textTheme.titleLarge?.color)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Empty Inventory', style: TextStyle(fontFamily: 'Poppins', fontSize: 22, fontWeight: FontWeight.w700, color: theme.textTheme.titleLarge?.color)),
            const SizedBox(height: 12),
            Text(
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Add First Item', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold)),
              style: ElevatedButton.styleFrom(
                backgroundColor: theme.primaryColor,
                foregroundColor: Colors.white,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Text('Sync Failed', style: TextStyle(fontFamily: 'Poppins', fontSize: 20, fontWeight: FontWeight.w700, color: theme.textTheme.titleLarge?.color)),
            const SizedBox(height: 8),
            Text(
              message,
              textAlign: TextAlign.center,
